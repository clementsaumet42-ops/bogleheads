"""Test de régression — Mission Dirigeant IS Holding.
...
class TestFiscal:
    ...
    def test_pea_plafond_atteint(self, expected):
        ...
        pea_versements = 150000.0  # from inputs.yaml versements_cumules
    ...
    def test_per_deduction_dirigeant(self, profil, expected):
