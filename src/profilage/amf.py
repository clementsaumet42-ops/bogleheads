...
class ProfilAMF(BaseModel):
    """Profil AMF — Connaissance et expérience (Art. 325-3 RG AMF)."""
    ...
    objectif_placement: str = Field(
        default="retraite",
        description="retraite | transmission | rendement | diversification | autre",
    )
    horizon_ans: int = Field(default=10, ge=0, le=50)
    aversion_risque_declaree: str = Field(
        default="moyenne",
