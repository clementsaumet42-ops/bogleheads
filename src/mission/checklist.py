...
ETAPES_CANONIQUES: list[Etape] = [
    ...
    Etape(
        ...
        page_streamlit="02_Lettre_de_Mission.py",
    ...
    Etape(
        ...
        page_streamlit="06_Audit_Patrimonial.py",
        depends_on=["profil_saisi"],
    ...
    Etape(
        ...
        page_streamlit="08_Monte_Carlo.py",
        depends_on=["allocation_cible"],
    ...
    Etape(
        ...
        page_streamlit="09_Rebalancement.py",
